 ...
 */
void (*serial_rx_isr_ptr)(unsigned char c);

void serial_init(void)
{
    serial_set_rx_isr_ptr(0L);
...
void serial_set_rx_isr_ptr(void (*isr_ptr)(unsigned char c)) 
{
    serial_rx_isr_ptr = isr_ptr;  
}
...
{
    if(serial_rx_isr_ptr != 0L) {
        (serial_rx_isr_ptr)(UCA0RXBUF);
    }
}
